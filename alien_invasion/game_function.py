...
def check_events(ai_settings,screen,stats,sb,play_button,ship,aliens,bullets):
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.QUIT:
            ...
            mouse_x, mouse_y = pygame.mouse.get_pos() #it will get cordinates of mouse click 
...
def create_alien(ai_settings, screen, aliens, alien_number,row_number):
    ...
    aliens.add(alien) #aliens is a Group
...
def update_aliens(ai_settings,screen,stats,sb,ship,aliens,bullets):
    ...
    if pygame.sprite.spritecollideany(ship, aliens): #check any member of sprite colide with group. if yes then return that alien and stop finding the more collision
        ship_hit(ai_settings,screen, stats,sb, ship, aliens, bullets)
...
value is the alien that was hit."""
    """firar True is used to delete bullet and second is used to delete aliens"""
    ...
    if len(aliens) == 0:
        ...
        bullets.empty() #removes all the remaining sprites from a group
